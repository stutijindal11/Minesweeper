...
{   MediaPlayer media,m1;
	...
	private int blockDimension = 45; // width of each block
	...
	public void onCreate(Bundle savedInstanceState){
		...
		Intent k=getIntent();
		 s=k.getStringArrayListExtra("s");
	     name=s.get(0);
	     pass=s.get(1);
	   
		media=MediaPlayer.create(this, R.raw.ticktock);
		media.setLooping(true);
		
		m1=MediaPlayer.create(this, R.raw.mine);
		m1.setLooping(true);
		m1.setVolume(100, 100);
		...
		showDialog("Click smiley to start New Game", 10000, true, false);
		showDialog("All the best "+name+" !", 10000, true, false);
	}
